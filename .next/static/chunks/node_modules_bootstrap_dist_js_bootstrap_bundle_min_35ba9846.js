...
"[project]/node_modules/bootstrap/dist/js/bootstrap.bundle.min.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
/*!
  ...
  */ !function(t, e) {
    ...
    const ot = ".bs.carousel", rt = ".data-api", at = "ArrowLeft", lt = "ArrowRight", ct = "next", ht = "prev", dt = "left", ut = "right", ft = "slide".concat(ot), pt = "slid".concat(ot), mt = "keydown".concat(ot), gt = "mouseenter".concat(ot), _t = "mouseleave".concat(ot), bt = "dragstart".concat(ot), vt = "load".concat(ot).concat(rt), yt = "click".concat(ot).concat(rt), wt = "carousel", At = "active", Et = ".active", Tt = ".carousel-item", Ct = Et + Tt, Ot = {
        [at]: ut,
        [lt]: dt
    }, xt = {
        interval: 5e3,
    ...
    const St = ".bs.collapse", Dt = "show".concat(St), $t = "shown".concat(St), It = "hide".concat(St), Nt = "hidden".concat(St), Pt = "click".concat(St, ".data-api"), jt = "show", Mt = "collapse", Ft = "collapsing", Ht = ":scope .".concat(Mt, " .").concat(Mt), Wt = '[data-bs-toggle="collapse"]', Bt = {
        parent: null,
        toggle: !0
    }, zt = {
        parent: "(null|element)",
    ...
    const wi = Object.freeze(Object.defineProperty({
        ...
        value: "Module"
    })), Ai = "dropdown", Ei = ".bs.dropdown", Ti = ".data-api", Ci = "ArrowUp", Oi = "ArrowDown", xi = "hide".concat(Ei), ki = "hidden".concat(Ei), Li = "show".concat(Ei), Si = "shown".concat(Ei), Di = "click".concat(Ei).concat(Ti), $i = "keydown".concat(Ei).concat(Ti), Ii = "keyup".concat(Ei).concat(Ti), Ni = "show", Pi = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)', ji = "".concat(Pi, ".").concat(Ni), Mi = ".dropdown-menu", Fi = p() ? "top-end" : "top-start", Hi = p() ? "top-start" : "top-end", Wi = p() ? "bottom-end" : "bottom-start", Bi = p() ? "bottom-start" : "bottom-end", zi = p() ? "left-start" : "right-start", Ri = p() ? "right-start" : "left-start", qi = {
        autoClose: !0,
    ...
    class Ki extends W {
        ...
        _getConfig(t) {
            if ("object" == typeof (t = super._getConfig(t)).reference && !o(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError("".concat(Ai.toUpperCase(), ': Option "reference" provided type "object" without a required "getBoundingClientRect" method.'));
            return t;
        }
        _createPopper() {
    ...
    const Qi = "backdrop", Xi = "show", Yi = "mousedown.bs.".concat(Qi), Ui = {
    ...
    const Zi = ".bs.focustrap", tn = "focusin".concat(Zi), en = "keydown.tab".concat(Zi), nn = "backward", sn = {
        autofocus: !0,
        trapElement: null
    }, on = {
        autofocus: "boolean",
    ...
    const un = ".bs.modal", fn = "hide".concat(un), pn = "hidePrevented".concat(un), mn = "hidden".concat(un), gn = "show".concat(un), _n = "shown".concat(un), bn = "resize".concat(un), vn = "click.dismiss".concat(un), yn = "mousedown.dismiss".concat(un), wn = "keydown.dismiss".concat(un), An = "click".concat(un, ".data-api"), En = "modal-open", Tn = "show", Cn = "modal-static", On = {
        backdrop: !0,
        focus: !0,
        keyboard: !0
    }, xn = {
    ...
    const Ln = ".bs.offcanvas", Sn = ".data-api", Dn = "load".concat(Ln).concat(Sn), $n = "show", In = "showing", Nn = "hiding", Pn = ".offcanvas.show", jn = "show".concat(Ln), Mn = "shown".concat(Ln), Fn = "hide".concat(Ln), Hn = "hidePrevented".concat(Ln), Wn = "hidden".concat(Ln), Bn = "resize".concat(Ln), zn = "click".concat(Ln).concat(Sn), Rn = "keydown.dismiss".concat(Ln), qn = {
        backdrop: !0,
        keyboard: !0,
        scroll: !1
    }, Vn = {
    ...
    m(bs);
    const vs = ".bs.scrollspy", ys = "activate".concat(vs), ws = "click".concat(vs), As = "load".concat(vs, ".data-api"), Es = "active", Ts = "[href]", Cs = ".nav-link", Os = "".concat(Cs, ", .nav-item > ").concat(Cs, ", .list-group-item"), xs = {
        offset: null,
    ...
    class Ls extends W {
        ...
        _clearActiveClass(t) {
            ...
            const e = z.find("".concat(Ts, ".").concat(Es), t);
    ...
    const Ss = ".bs.tab", Ds = "hide".concat(Ss), $s = "hidden".concat(Ss), Is = "show".concat(Ss), Ns = "shown".concat(Ss), Ps = "click".concat(Ss), js = "keydown".concat(Ss), Ms = "load".concat(Ss), Fs = "ArrowLeft", Hs = "ArrowRight", Ws = "ArrowUp", Bs = "ArrowDown", zs = "Home", Rs = "End", qs = "active", Vs = "fade", Ks = "show", Qs = ".dropdown-toggle", Xs = ":not(".concat(Qs, ")"), Ys = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', Us = ".nav-link".concat(Xs, ", .list-group-item").concat(Xs, ', [role="tab"]').concat(Xs, ", ").concat(Ys), Gs = ".".concat(qs, '[data-bs-toggle="tab"], .').concat(qs, '[data-bs-toggle="pill"], .').concat(qs, '[data-bs-toggle="list"]');
    class Js extends W {
        static get NAME() {
            return "tab";
        }
    ...
    const Zs = ".bs.toast", to = "mouseover".concat(Zs), eo = "mouseout".concat(Zs), io = "focusin".concat(Zs), no = "focusout".concat(Zs), so = "hide".concat(Zs), oo = "hidden".concat(Zs), ro = "show".concat(Zs), ao = "shown".concat(Zs), lo = "hide", co = "show", ho = "showing", uo = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, fo = {
...
//# sourceMappingURL=node_modules_bootstrap_dist_js_bootstrap_bundle_min_35ba9846.js.map